...
//These are called ACCUMULATOR variables. They hold something
...
let highestProfitMonthName = '';
let highestLossesMonth = 0;
let highestLossesMonthName = '';

for (let i = 0; i < finances.length; i++) {
    // track the name of the month
    let monthlyName = finances[i][0]
